  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 min-h-[100dvh]">
      ...
      <header className="text-center mb-12">
        <h1 className="text-4xl font-extrabold text-foreground mb-3 tracking-tight">HaruLog</h1>
        <p className="text-lg text-slate-500 font-medium">너의 하루를 몽글몽글하게 기록해봐</p>
      </header>

      <main className="w-full max-w-sm flex flex-col gap-6">
        <Link href="/diary/write" className="fluffy-card text-left flex items-center gap-4 group active:bg-haru-sky-light transition-colors cursor-pointer">
        ...
        <Link href="/diary/list" className="fluffy-card text-left flex items-center gap-4 group active:bg-haru-sky-light transition-colors cursor-pointer">
        ...
        <Link href="/statistics" className="fluffy-card text-left flex items-center gap-4 group active:bg-haru-sky-light transition-colors cursor-pointer">
          <div className="w-12 h-12 bg-haru-sky-medium rounded-2xl flex items-center justify-center text-2xl group-active:scale-90 transition-transform">✨</div>
          <div>
